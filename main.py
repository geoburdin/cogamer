...
class ChooseLanguageWindow:
    ...
    def run(self):
        self.root.mainloop()
        return (self.basic_voice.get(), self.do_start_cogamer)
...
if __name__ == "__main__":
    ...
    voice, do_start_cogamer = choose_language_window.run()
    if do_start_cogamer: cogamer.cogamer(chosen_voice=voice)
